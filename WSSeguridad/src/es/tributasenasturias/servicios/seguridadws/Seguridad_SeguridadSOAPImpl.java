...
public class Seguridad_SeguridadSOAPImpl implements Seguridad {
     ...
     *     returns java.lang.String
     */
    public String firmarMensajeAlgoritmo(String mensaje, String aliasCertificado, String uriAlgoritmoFirma, String uriAlgoritmoDigest) {
        FirmanteMensaje firma=null;
        try {
        	firma=new FirmanteMensaje();
	 ...
	 * @return returns java.lang.String
	 */
	public String firmarMensajeAlgoritmoConTimestamp(String mensaje,
        ...
        try {
        	firma=new FirmanteMensaje();
			return firma.firmaMensajeAlgoritmoTimestamp(mensaje, aliasCertificado, uriAlgoritmoFirma, uriAlgoritmoDigest, intervaloSegundosExpiracion);
		} catch (WSSecurityException e) {
			throw new WebServiceException("Error en la firma:" + e.getMessage());
		} catch (FirmaException e) {
			throw new WebServiceException ("Error en la firma:" + e.getMessage());
