...
public class FirmanteMensaje{
	 ...
	 * @throws WSSecurityException
	 */
	public String firmaMensajeAlgoritmoTimestamp (String mensaje, String aliasCertificado, String uriAlgoritmoFirma, String uriAlgoritmoDigest,int intervaloSegundosExpiracion) throws FirmaException, WSSecurityException
	{
		WSSecSignature builder = new WSSecSignature();
		builder.setKeyIdentifierType(WSConstants.BST_DIRECT_REFERENCE);
		...
		builder.setSignatureAlgorithm(uriFirma);
		builder.setDigestAlgo(uriDigest);
		Document doc=null;
		try {
			doc = Utils.string2Doc(mensaje);
		} catch (Exception e) {
	...
	{
		return firmaMensajeAlgoritmoTimestamp(mensaje, aliasCertificado, uriAlgoritmoFirma, uriAlgoritmoDigest,0); 
	}
