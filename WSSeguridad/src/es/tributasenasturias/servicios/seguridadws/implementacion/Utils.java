...
public class Utils {
	 ...
	 * @throws Exception en caso de que falle la conversión.
	 */
	...
	/**
	 * Convierte un documento de {@link Document} en su representación en cadena.
	 * @param doc Documento a transformar
	 * @return Representación en cadena del documento.
	 ...
	 * @param palabra Palabra a la que se aplicará transformación.
